    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 p-1 md:p-5 flex justify-center items-center flex-col space-y-6">
                ...
                <h2 className={`text-white font-semibold text-xl mt-4 flex items-center gap-2 ${merienda.className}`}><FaStarHalfAlt  className='text-green-500'/> Cholo Kheli! Say yes to fitness and no to drugs. <br /> Book your favorite local sports  instantly.</h2>
