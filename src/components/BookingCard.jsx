  ...
  return (
    <div>
      <Card>
        ...
        <DatePicker className="" name="date" value={date} onValueChange={setDate}>
    ...
    <Button onClick={handleBooking} className="bg-[#541A1A] text-white w-full rounded-md">Book Now</Button>
      </Card>
