...
const SimpleStep = () => {
  return (
    <div>
      <h1
        className={`text-4xl font-bold text-center mb-8 ${merienda.className}`}
      >
      ...
      <VerticalTimeline>
        ...
        >
          ...
          <p>selsecg your own favorite sport and comafrm it</p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          date=""
        ...
        >
          ...
          <p>after bookinn g you must logg in or sing in user</p>
        </VerticalTimelineElement>
        ...
        >
          <h3 className="vertical-timeline-element-title font-bold">
            On detai page Book Naw on button
          </h3>
          <h4 className="vertical-timeline-element-subtitle">
            Final booking steps
          </h4>
          <p>Finaly Booked your Drem sport</p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
